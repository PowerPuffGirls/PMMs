...
#trip = []
#trip.append( Walk( 'KMITL', 'KMITL SCB Bank', 0.6 ))
#trip.append( Taxi( 'KMITL SCB Bank', 'Lardkrabang Station', 5))
#trip.append( Train( 'Lardkrabang Station', 'Payathai Station', 40, 6 ))
#trip.append( Taxi( 'Payathai Station', 'The British Council' 3))
